...
const TeacherListPage = () => {
  const renderRow = (item: Teacher) => (
    <tr className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLight">
      ...
      <th className="hidden md:table-cell">{item.teacherId}</th>
      <th className="hidden md:table-cell">{item.subjects.join(",")}</th>
      <th className="hidden md:table-cell">{item.classes.join(",")}</th>
